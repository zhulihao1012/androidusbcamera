...
import com.arcsoft.arcfacedemo.Util;

import java.io.IOException;
import java.util.List;

import static com.arcsoft.arcfacedemo.activity.Main1Activity.metrics;

/**
 * 相机辅助类，和{@link CameraListener}共同使用，获取nv21数据等操作
 */
public class CameraHelper extends Point implements Camera.PreviewCallback {
    private static final String TAG = "CameraHelper";
    private  Camera.Size preSize;
    private Camera mCamera;
    private int mCameraId;
    private Point previewViewSize;
    private Point previewViewSize2;
 ...
 canUse = false;
  ...
  return canUse;
    ...
    public Camera.Size getCameraSize() {
        ...
        Log.e("met1",""+metrics.widthPixels);
        return preSize;
    ...
    public void start( ) {
        synchronized (this) {
            ...
            Log.e("相机摄像头数量",""+ Camera.getNumberOfCameras());
            Log.e("相机",""+ specificCameraId);
            Log.e("", String.valueOf(isCameraCanUse()));
...
//                cameraListener.onCameraError(new Exception("camera not found"));
            ...
            displayOrientation = getCameraOri(rotation);
            Log.e("rotation",""+displayOrientation);
           mCamera.setDisplayOrientation(displayOrientation);
...
//        if (zxc != Configuration.ORIENTATION_LANDSCAPE) {
////          result=(zxc-degrees+360)%360;
//            result = 270;
//        } else {//如果是横屏
//            result=0;
//        }
